...
<head>
    ...
    <title>Halaman Kabid Data</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url("assets/");?>index.html">WEBERTE</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Kabid Data</div>
                    <div class="email">thor@avenger.com</div>
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <!--ul class="ml-menu">
                                    <li>
                                        <a href="<?php echo base_url("assets/");?>pages/widgets/cards/basic.html">RT 01</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url("assets/");?>pages/widgets/cards/colored.html">RT 02</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url("assets/");?>pages/widgets/cards/no-header.html">RT 03</a>
                                    </li>
                                </ul-->
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="<?php echo base_url("assets/");?>pages/widgets/infobox/infobox-1.html">RT 01</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url("assets/");?>pages/widgets/infobox/infobox-2.html">RT 02</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url("assets/");?>pages/widgets/infobox/infobox-3.html">RT 03</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo base_url("assets/");?>pages/widgets/infobox/infobox-4.html">RT 04</a>
                                    </li>
                                    <li>
                    ...
                    <li class="active">
                        ...
                        <!--a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <span>Daftar Kegiatan Warga</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 <a href="javascript:void(0);">WEBERTE</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
