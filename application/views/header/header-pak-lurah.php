...
<body class="theme-blue ls-closed overlay-open">
    <!-- Page Loader -->
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pak Lurah</div>
                    <div class="email">iron.man@avenger.com</div>
