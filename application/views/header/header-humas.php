        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Humas</div>
                    <div class="email">humaskece@avenger.com</div>
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url("assets/");?>pages/widgets/infobox/infobox-1.html">
                                    <span>Masukkan Baru</span>
                                </a>
                            </li>
                        </ul>
                    </li>
